  ...
  <div class="multi-stats pl-lg-4">
    ...
    <div class="stats d-flex flex-column bg-dark p-3">
      <SingleStat
        ...
        ico-name="skull"
        ico-color="#9E9E9E"
        v-bind:info="{value: stats.kills.monsters, text:'Lifetime Kills'}" />

      <SingleStat
        class="mb-3"
        ico-name="crown"
        ico-color="#ffc107"
        v-bind:info="{value: stats.kills.elites, text:'Elite Kills'}"/>

      <SingleStat
        ico-name="dungeon"
        ico-color="#795548"
        v-bind:info="{value: stats.paragonLevel, text:'Paragon Level'}"/>
    </div>

    <time-played v-bind:timePlayed="timePlayed"/>
